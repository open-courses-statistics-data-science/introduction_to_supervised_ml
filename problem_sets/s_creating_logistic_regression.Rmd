...
13. Run the following code which does maximum likelihood estimation for you. Compare the estimates below with your ones above. `model <- glm(Survived~class_1+class_2, data=df, family="binomial")`
`
